...
class NMM_Gateway extends WC_Payment_Gateway
{
    ...
    public function admin_options()
    {
        ...
        <div class="nmm-options">
            ...
            <a href=<?php echo get_site_url() . '/wp-admin/admin.php?page=' . NMM_REDUX_SLUG . '&tab=1'; ?>>ETHOPay Plugin Settings</a>
        </div>
        <?php
    }
                ...
                <p style="word-wrap: break-word;">Total:
                    <strong>
                        <span class="woocommerce-Price-amount amount">
                          <?php
                                                          if ($crypto->get_symbol() === '') {
                                                              echo '<span class="no-copy">&nbsp' . $crypto->get_id() . '</span>' . '<span class="all-copy"> <p> </p>' . $formattedPrice . '</span>';
                                                          } else {
                                                              echo'<span class="all-copy">' . $formattedPrice . '</span>' . '<span class="no-copy"><p> </p>' . $crypto->get_symbol() . '</span>';
                                                          } ?>
                        </span>
                    </strong>
                </p>
