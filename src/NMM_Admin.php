...
$nmm_redux_args = array(
    ...
    //'intro_text'           => apply_filters('nmm_settings_intro', 'Welcome to the ETHOPay Settings Page'),
    'system_info'          => true,
    'hide_expand'          => true,
...
foreach ($nmm_cryptos as $nmm_crypto) {
    ...
    if ($nmm_crypto->has_autopay()) {
        $nmm_section['fields'][] = array(
            ...
            'required' => array($nmm_crypto->get_id() . '_mode', 'equals', '1'),
            'desc' => 'Auto-Payment will automatically confirm payments that are within this percentage of the total amount requested. This should stay default. Change at your own risk.',
        );
...
$nmm_section = array(
    ...
    'fields'   => array(
        array(
            ...
            'default' => array(0),
            'multi' => true,
            'desc' => 'Price is an average of the CryptoCompare API.',
